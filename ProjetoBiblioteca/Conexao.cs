...
namespace ProjetoBiblioteca
{
    class Conexao
    {
        ...
        MySqlConnection con = new MySqlConnection("Data Source=localhost;Initial Catalog=BDBiblioteca;user=root;pwd=Nick26718908088888212*"); //ísso atras é a string de conexao.
